...
prepend_if_missing = $(if $(filter ${1}%,${2}),${2},${1}${2})
append_if_missing = $(if $(filter %${2},${1}),${1},${1}${2})

is_path_relative = $(if $(or $(filter-out /%,${1}),$(filter . ..,$(subst /, ,${1}))),${1})
is_path_absolute = $(if $(and $(filter /%,${1}),$(if $(filter . ..,$(subst /, ,${1})),,1)),${1})
resolve_path_if_not_absolute = $(or $(call is_path_absolute,${1}),$(realpath ${1}))
...
$(if $(or ${dir_exists[${1}]},$(wildcard ${1}/)),,$(call create_dir_list,${1})$(eval dir_exists[${1}] := 1))
...
remove_dir ?= $(call remove_dir_list,${1})$(eval undefine dir_exists[${1}])
