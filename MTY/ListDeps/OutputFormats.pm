...
# -*- cperl -*-
#
# MTY::ListDeps::OutputFormats
#
# Copyright 2015 Matt T. Yourst <yourst@yourst.com>
#

package MTY::ListDeps::OutputFormats;
use integer; use warnings; use Exporter qw(import);

our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(format_deps_as_tree @output_format_specs format_deps_with_graphviz
     format_deps_using_template condense_filenames_by_directory
     __format_deps_using_template_internal);
...
my $tree_format_spec = {
  ...
  compatible_dep_types => [ DIRECT_DEPS ],
  # (private fields defined by each formatting plugin):
};
