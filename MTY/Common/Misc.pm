...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(COMPARE_EQ COMPARE_GE COMPARE_GT COMPARE_LE COMPARE_LT COMPARE_NE
     COMPARE_OR COMPARE_TO COMPARE_AND COMPARE_NOR COMPARE_NOT COMPARE_XOR
     extractbits binary_search COMPARE_ANDNOT COMPARE_REGEXP compare_arrays
     COMPARE_STRINGS compare_strings COMPARE_INTEGERS COMPARE_MASK_ALL
     COMPARE_MASK_ANY compare_integers COMPARE_MASK_NONE COMPARE_NOT_REGEXP
     COMPARE_MASK_NOT_ALL create_line_offset_map compare_with_expression
     masked_store_into_array partition_into_subarrays
     find_line_containing_offset topological_sort_dependencies
     partition_into_parallel_arrays compare_vec_to_scalar_and_generate_bitmask);
