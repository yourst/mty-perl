...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(COMPARE_AND COMPARE_ANDNOT COMPARE_EQ COMPARE_GE COMPARE_GT
     ...
     hash_of_constants_in_package is_constant list_of_constants_in_package
...
sub find_line_containing_offset($$+) {
  ...
  my $col = $nearest_offset - $line_to_offset_map->[$line];
  return (wantarray ? ($line, $col) : $line);
}
