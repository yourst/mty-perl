...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(get_stack_backtrace print_stack_backtrace dump_stack_trace_and_die
     dump_stack_trace_and_warn get_caller_and_args_at_level
     simple_format_stack_backtrace
     %skip_packages_and_functions_in_stack_backtrace);
...
sub dump_stack_trace_and_die {
  my ($package, $filename, $line, $function) = caller(0);

  printfd(STDERR, 'Stack trace invoked by exception at ', 
          ($filename // '<undef>'), ':', ($line // '<undef>'), ': ', NL);
...
#  $SIG{__DIE__} = \&dump_stack_trace_and_die;
#  $SIG{__WARN__} = \&dump_stack_trace_and_warn;
};
