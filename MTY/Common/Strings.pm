...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($control_chars_re %boolean_words @powers_of_1024_unit_names ALIGN_CENTER
     ...
     format_hex format_size_with_units insert_thousands_separators
     interpolate_control_chars join_undefs join_undefs_with_sep
     join_with_prefix_and_suffix length_with_thousands_separators maxlength
     padstring padstring_with_suffix padstrings
     parse_list_of_key_equals_value_into_hash printed_length remove_from_end
     remove_from_start remove_leading_space remove_leading_trailing_space
     ...
     split_into_words_and_line_breaks starts_with substitute_placeholders
     truncate_printed_string truncate_printed_strings word_wrap_long_lines
     wrap_long_lines);

push @EXPORT, @MTY::Common::SimpleFormat::EXPORT;
