...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(add_missing_arrays_to_hash add_missing_hashes_to_hash
     ...
     array_to_histogram_hash count_keys_matching_list hash_contains_all_keys
     hash_contains_any_of_keys hash_is_missing_all_keys hash_to_array_of_pairs
     hash_to_scope invert_hash invert_hash_dups_to_subarrays
     key_list_of_hash_sorted_by_values keysof merge_hashes
