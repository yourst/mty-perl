...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($color_markup_re $ansi_rgb_color_re $ansi_reset_colors_re
     $ansi_rgb_bg_color_re $ansi_rgb_fg_color_re $ansi_indexed_color_re
     $ansi_indexed_bg_color_re $ansi_indexed_fg_color_re
     $colorize_markup_chars_re $ansi_console_escape_codes_re
     $ansi_rgb_or_indexed_color_re strip_ansi_console_escape_codes
     $ansi_rgb_or_indexed_bg_color_re $ansi_rgb_or_indexed_fg_color_re
