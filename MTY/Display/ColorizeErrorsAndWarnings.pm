...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($abort_on_warnings $die_error_message $include_stack_backtrace
     ...
     die_or_warn_in_color format_stack_backtrace get_stack_trace
...
sub get_stack_trace() {
  ...
  for (my $level = 0; ; $level++) {
    my ($package, $filename, $line, $function) = caller($level);
    last if (!defined $package);
    push @stack, [ $filename, $line, $package, $function ];
  }
