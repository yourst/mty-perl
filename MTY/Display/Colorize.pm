...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($B $BLINK $BLINKX $C $CLEAR_SCREEN $CLEAR_TAB_STOPS
     ...
     Y_1_2 Y_1_3 Y_1_4 Y_2_3 Y_3_4 adjust_luminance bgB bgC bgG bgK bgM bgQ
     bgR bgW bgY bg_color_rgb bg_gray blend_and_scale_rgb_bg
     ...
     enable_color_based_on_stdout fg_color_rgb fg_gray get_tab_stop_codes
     ...
     reveal_ansi_console_escape_codes rgbB rgbC rgbG rgbK rgbM rgbQ rgbR rgbW
     rgbY rgb_of_color_code rgb_of_color_code_components rgbbgB rgbbgC rgbbgG
     rgbbgK rgbbgM rgbbgQ rgbbgR rgbbgW rgbbgY rgbfgB rgbfgC rgbfgG rgbfgK
     rgbfgM rgbfgQ rgbfgR rgbfgW rgbfgY scale_rgb scale_rgb_bg
     scale_rgb_bg_in_string scale_rgb_fg scale_rgb_fg_in_string
