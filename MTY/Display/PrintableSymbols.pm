...
BEGIN {
  our %symbol_groups = (
    ...
    left_parens_braces_brackets => [
      ...
      single_left_angle_bracket                => chr(0x2329),
      alt_single_left_angle_bracket            => chr(0x27e8),
      wide_alt_single_left_angle_bracket       => chr(0x3008),
      double_left_angle_bracket                => chr(0x27ea),
      alt_double_left_angle_bracket            => chr(0x300a),
    ...
    right_parens_braces_brackets => [
      ...
      single_right_angle_bracket               => chr(0x232a),
      alt_single_right_angle_bracket           => chr(0x27e9),
      wide_alt_single_right_angle_bracket      => chr(0x3009),
      double_right_angle_bracket               => chr(0x27eb),
      alt_double_right_angle_bracket           => chr(0x300b),
    ...
    special_symbols => [
      ...
      small_null_circle                        => chr(0x2300), # circle with long diagonal line drawn through it
      null_circle                              => chr(0x00d8), # circle with long diagonal line drawn through it
    ...
    colons => [
      ...
      light_double_colon                       => chr(0x0589).chr(0x0589),
    ...
    superscript_letters => [
      superscript_lowercase_b                  => chr(0x1483),
      superscript_lowercase_d                  => chr(0x1484),
      superscript_lowercase_l                  => chr(0x144a),
      superscript_lowercase_h                  => chr(0x144b),
      superscript_lowercase_r                  => chr(0x02b3),
      superscript_lowercase_j                  => chr(0x02b2),
      superscript_lowercase_w                  => chr(0x02b7),
      superscript_lowercase_y                  => chr(0x02b8),
      superscript_lowercase_c                  => chr(0x1d9c),
      superscript_lowercase_f                  => chr(0x1da0),
      superscript_lowercase_g                  => chr(0x1da2),
      superscript_lowercase_z                  => chr(0x1dbb),
      superscript_c                            => chr(0x14bc),
      superscript_j                            => chr(0x14a2),
      superscript_l                            => chr(0x14bb),
      superscript_m                            => chr(0x153f),
      superscript_n                            => chr(0x1db0),
      superscript_s                            => chr(0x1506),
      superscript_t                            => chr(0x142a),
      superscript_u                            => chr(0x14d1),
      superscript_v                            => chr(0x1601),
      superscript_x                            => chr(0x1541),
      alt_superscript_x                        => chr(0x157d),
    ...
    dots => [
      ...
      open_dot                                 => chr(0x26ac),
      dot_above                                => chr(0x02d9),
      circle_above                             => chr(0x02da),
      square_dot                               => chr(0x25a0),
      middle_dot_wide_spacing                  => chr(0x30fb),
    ],
    x => [
    ...
    superscript_symbols => [
      ...
      superscript_open_up_arrow_triangle       => chr(0x141e),
    ],
    fractions => [
