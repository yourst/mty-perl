...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($split_leading_spaces_from_text_re $tree_branch_color
     ...
     $tree_root_symbol_and_color $tree_subnode_count_if_no_subnodes
     $tree_subnode_count_prefix $tree_subnode_count_suffix $tree_vert_dashed
     %tree_command_name_to_id %tree_styles BRANCH
     ...
     TREE_CMD_FIELD TREE_CMD_IF_EVEN TREE_CMD_IF_ODD TREE_CMD_LABEL
     TREE_CMD_PREFIX TREE_CMD_SUBNODE_COUNT TREE_CMD_SYMBOL
     ...
     tree_of_hashes_to_printable_tree tree_to_lines tree_to_text);
