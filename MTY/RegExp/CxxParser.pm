...
nobundle:; our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(tokenize_cxx $debug_strings parse_struct_def $cxx_parser_error
     print_tokenized_cxx @cxx_token_type_names $leading_whitespace_re
     $nl_cr_ff_not_bs_nl_re $print_token_type_names @cxx_token_type_to_color
     print_parsed_struct_enums @cxx_token_type_full_names
     print_parsed_struct_fields reinsert_extracted_strings
     reconstruct_member_function print_parsed_struct_function
     print_parsed_struct_typedefs reconstruct_member_functions
     print_parsed_struct_functions $print_whitespace_after_tokens
     cxx_tokenize_and_extract_strings tokenize_and_extract_strings_callback
     replace_tokens_with_macro_defs_callback
     $enable_template_angle_bracket_special_case);
...
sub reconstruct_member_function($$+) {
  ...
  $out .= ' : ' . $constructor_initializer_list if (is_there($constructor_initializer_list));
  $out .= ' = ' . $default_or_delete_or_purevirt_suffix if (is_there($default_or_delete_or_purevirt_suffix));
