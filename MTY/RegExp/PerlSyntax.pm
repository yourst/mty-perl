...
nobundle:; our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($auto_import_clause_re $balanced_symbol_chars_re $end_of_includes_re
     ...
     $perl_attributes_re $perl_comment_re $perl_constant_decl_re
     $perl_constant_to_value_mapping_re $perl_delimited_block_pair_re
     $perl_delimited_block_re $perl_double_quoted_or_qq_string_re
     $perl_double_quoted_string_re $perl_end_block_re $perl_exports_clause_re
     $perl_here_doc_re $perl_identifier_decl_or_use_re $perl_identifier_re
     ...
     $perl_package_deps_re $perl_package_name_re
...
our @perl_keywords_and_built_in_functions =
  qw(ARGV ARGVOUT BEGIN CHECK ENV END FALSE INC INIT SIG STDERR STDIN STDOUT 
     ...
     fileno flock for foreach my fork format formline ge getc getgrent getgrgid 
...
our $perl_package_decls_and_deps_re = compile_regexp(
  qr{(?|
     ...
     'Extension of perl_package_deps_re which also captures package declarations.');
