...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($angle_brackets_re $braces_re
     ...
     $inside_of_angle_brackets_re $inside_of_braces_re $inside_of_parens_re
     $inside_of_square_brackets_re $key_equals_or_colon_value_comma_re
...
our $inside_of_parens_re = compile_regexp(
...
our $inside_of_braces_re = compile_regexp(
  generate_inside_of_balanced_char_pair_re('{', '}'),
 'inside_of_braces', 
...
our $inside_of_square_brackets_re = compile_regexp(
  generate_inside_of_balanced_char_pair_re('[', ']'),
...
our $inside_of_angle_brackets_re = compile_regexp(
  generate_inside_of_balanced_char_pair_re('<', '>'),
...
our $key_equals_or_colon_value_comma_re = compile_regexp
  (qr{\G \s*+ ([^\=\:]++) \s*+ (?> [\=\:] \s*+ ([^\,]++)) (?> ,|\Z)}oamsx,
   'key_equals_or_colon_value_comma',
