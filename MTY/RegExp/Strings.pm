...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($backslash_newline_re $boolean_words_re $double_quoted_string_re
     ...
     $null_terminated_string_re $printable_chars_re $quote_type_and_text_re
     $quoted_string_nocap_re $quoted_string_re
     $remove_leading_trailing_space_re $single_quoted_string_re
     $split_by_char_classes_re $tab_field_re $title_case_identifier_re
     $trailing_spaces_re $unicode_and_non_ascii_chars_re
     $upper_case_identifier_re $utf8_re join_backslash_newline_escaped_lines);
