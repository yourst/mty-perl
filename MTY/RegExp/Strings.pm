...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($double_quoted_string_re $identifier_re $inside_double_quoted_re
     $inside_quoted_re $inside_single_quoted_string_nocap_re
     $leading_spaces_re $line_re $lower_case_identifier_re
     $null_terminated_string_re $printable_chars_re $quoted_literal_nocap_re
     $quoted_nocap_re $quoted_re $raw_delimited_string_re
     $remove_leading_trailing_space_re $simple_quoted_re
     $single_quoted_character_re $single_quoted_string_re
