...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(get_host_name get_user_info get_user_name get_home_directory
     is_user_member_of_group lookup_user_name_from_uid
     get_current_uid_gid_groups get_terminal_char_dev_path
     lookup_group_name_from_gid);
