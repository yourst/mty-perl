...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(OPEN_ON_FD OPEN_FOR_MMAP get_script_path OPEN_AS_ROOT_DIR
     OPEN_AS_EXECUTABLE classify_fd_target OPEN_AS_CURRENT_DIR
     find_all_open_files get_local_socket_path find_files_opened_by_pid
     get_invoked_command_name @open_type_to_description
     first_pid_with_fd_open_on get_unix_local_socket_info
     get_real_command_name_of_pid @open_type_to_long_description
     get_pid_of_first_consumer_of_fd @open_type_to_padded_description
     get_pid_of_first_consumer_of_stderr get_pid_of_first_consumer_of_stdout
     find_all_open_files_fast_skip_details
     @open_type_to_single_letter_description
     find_files_opened_by_pid_fast_skip_details
...
sub find_files_opened_by_pid_fast_skip_details($;+) {
  ...
  foreach my $mapped_filename (@$maps) { $pathnames->{$mapped_filename}++; }

  my @fdlist = read_proc_subdir($pid, 'fd');

  foreach my $desc (@fdlist) {
