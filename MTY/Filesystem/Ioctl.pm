...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(IOCTL_FIBMAP IOCTL_FITHAW IOCTL_FITRIM IOCTL_BLKIOMIN IOCTL_BLKIOOPT
     IOCTL_BLKRAGET IOCTL_BLKRASET IOCTL_BLKROGET IOCTL_BLKROSET
     IOCTL_FIFREEZE IOCTL_FIGETBSZ ioctl_set_byte IOCTL_BLKBSZGET
     IOCTL_BLKBSZSET IOCTL_BLKFLSBUF IOCTL_BLKFRAGET IOCTL_BLKFRASET
     IOCTL_BLKRRPART IOCTL_BLKSSZGET ioctl_set_int16 ioctl_set_int32
     ioctl_set_int64 ioctl_set_ubyte IOCTL_BLKDISCARD IOCTL_BLKGETSIZE
     IOCTL_BLKPBSZGET IOCTL_BLKSECTGET IOCTL_BLKSECTSET IOCTL_BLKZEROOUT
     IOCTL_TIOCGWINSZ IOCTL_TIOCSWINSZ ioctl_query_byte ioctl_set_uint16
     ioctl_set_uint32 ioctl_set_uint64 IOCTL_BLKALIGNOFF IOCTL_FORMAT_BYTE
     ioctl_query_int16 ioctl_query_int32 ioctl_query_int64 ioctl_query_ubyte
     IOCTL_BLKGETSIZE64 IOCTL_FORMAT_INT16 IOCTL_FORMAT_INT32
     IOCTL_FORMAT_INT64 IOCTL_FORMAT_UBYTE get_block_dev_size
     ioctl_query_uint16 ioctl_query_uint32 ioctl_query_uint64
     IOCTL_BLKROTATIONAL IOCTL_BLKSECDISCARD IOCTL_FORMAT_UINT16
     IOCTL_FORMAT_UINT32 IOCTL_FORMAT_UINT64 IOCTL_FS_IOC_FIEMAP
     IOCTL_FS_IOC_GETFLAGS IOCTL_FS_IOC_SETFLAGS ioctl_set_with_format
     IOCTL_BLKDISCARDZEROES IOCTL_FS_IOC32_GETFLAGS IOCTL_FS_IOC32_SETFLAGS
     IOCTL_FS_IOC_GETVERSION IOCTL_FS_IOC_SETVERSION ioctl_query_with_format
     get_terminal_window_size IOCTL_FS_IOC32_GETVERSION
     IOCTL_FS_IOC32_SETVERSION ioctl_open_and_set_with_format
     ioctl_open_and_query_with_format);
