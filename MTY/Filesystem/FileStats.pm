...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(%file_type_to_description %stat_field_name_to_index_map
     ...
     PERM_SETUID PERM_STICKY PERM_W PERM_X STATS_QUERY_BASE STAT_ACL
     STAT_ATIME STAT_ATIME_NS STAT_BLOCK_CHAR_DEV_SPEC STAT_BLOCK_COUNT
     STAT_BLOCK_SIZE STAT_CAPABILITIES STAT_CTIME STAT_CTIME_NS
     STAT_DEFAULT_ACL STAT_DEV STAT_EXTENTS STAT_FIELD_COUNT STAT_FSFLAGS
     STAT_FSTYPE STAT_GID STAT_INODE STAT_IS_ACCESSIBLE STAT_LOCKS STAT_MODE
     STAT_MTIME STAT_MTIME_NS STAT_NAME STAT_NLINK STAT_OPENFD STAT_PATH
     STAT_SIZE STAT_SUBSET STAT_SYMLINK STAT_TYPE STAT_UID STAT_XATTRS
     S_IFMT_SHIFT dev_node_matches_major_minor_type file_stats_to_hash
