...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(%file_type_to_description %stat_field_name_to_index_map
     ...
     FILE_TYPE_VOLATILE_MOUNT PERM_FIELD_ACL PERM_FIELD_EFFECTIVE PERM_FIELD_G
     PERM_FIELD_O PERM_FIELD_S PERM_FIELD_U PERM_R PERM_SETGID PERM_SETUID
     PERM_STICKY PERM_W PERM_X STATS_QUERY_BASE STAT_ACL STAT_ATIME
     STAT_ATIME_NS STAT_BLOCK_CHAR_DEV_SPEC STAT_BLOCK_COUNT STAT_BLOCK_SIZE
