...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(PERM_R PERM_W PERM_X STAT_ACL STAT_DEV STAT_GID STAT_UID STAT_MODE
     STAT_NAME STAT_PATH STAT_SIZE STAT_TYPE STAT_ATIME STAT_CTIME STAT_INODE
     STAT_LOCKS STAT_MTIME STAT_NLINK PERM_SETGID PERM_SETUID PERM_STICKY
     PERM_USER_R PERM_USER_W PERM_USER_X STAT_FSTYPE STAT_OPENFD STAT_SUBSET
     STAT_XATTRS PERM_FIELD_G PERM_FIELD_O PERM_FIELD_S PERM_FIELD_U
     PERM_GROUP_R PERM_GROUP_W PERM_GROUP_X PERM_OTHER_R PERM_OTHER_W
     PERM_OTHER_X STAT_EXTENTS STAT_FSFLAGS STAT_SYMLINK S_IFMT_SHIFT
     FILE_TYPE_DIR STAT_ATIME_NS STAT_CTIME_NS STAT_MTIME_NS FILE_TYPE_FILE
     FILE_TYPE_PIPE PERM_FIELD_ACL FILE_TYPE_COUNT STAT_BLOCK_SIZE
     FILE_TYPE_SOCKET STATS_QUERY_BASE STAT_BLOCK_COUNT STAT_DEFAULT_ACL
     STAT_FIELD_COUNT FILE_TYPE_SPECIAL FILE_TYPE_SYMLINK STAT_CAPABILITIES
     mode_to_file_type FILE_TYPE_CHAR_DEV FILE_TYPE_MASK_ANY
     FILE_TYPE_MASK_DIR FILE_TYPE_SNAPSHOT STAT_IS_ACCESSIBLE
     file_stats_to_hash FILE_TYPE_BLOCK_DEV FILE_TYPE_MASK_FILE
     FILE_TYPE_MASK_PIPE FILE_TYPE_SUBVOLUME FILE_TYPE_BIND_MOUNT
     FILE_TYPE_FUSE_MOUNT PERM_FIELD_EFFECTIVE join_major_minor_dev
     FILE_TYPE_MASK_NORMAL FILE_TYPE_MASK_SOCKET FILE_TYPE_MOUNT_POINT
     split_major_minor_dev @file_stat_field_names @file_stat_field_types
     FILE_TYPE_MASK_SPECIAL FILE_TYPE_MASK_SYMLINK FILE_TYPE_MASK_CHAR_DEV
     FILE_TYPE_MASK_READABLE FILE_TYPE_NETWORK_MOUNT FILE_TYPE_SPECIAL_MOUNT
     FILE_TYPE_MASK_BLOCK_DEV FILE_TYPE_VOLATILE_MOUNT
     STAT_BLOCK_CHAR_DEV_SPEC %file_type_to_description
     FILE_TYPE_ANONYMOUS_MOUNT FILE_TYPE_BLOCK_DEV_MOUNT
     %stat_field_index_to_name_map %stat_field_name_to_index_map
     dev_node_matches_major_minor_type);
...
sub file_stats_to_hash(+) {
  return pair_of_arrays_to_hash(@file_stat_field_names, $_[0]);
}
