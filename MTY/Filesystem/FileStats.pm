...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(%file_type_to_description %stat_field_name_to_index_map
     ...
     FILE_TYPE_MOUNT_POINT FILE_TYPE_NETWORK_MOUNT FILE_TYPE_PIPE
     FILE_TYPE_SNAPSHOT FILE_TYPE_SOCKET FILE_TYPE_SPECIAL
     FILE_TYPE_SPECIAL_MOUNT FILE_TYPE_SUBVOLUME FILE_TYPE_SYMLINK
     FILE_TYPE_VOLATILE_MOUNT PERM_FIELD_ACL PERM_FIELD_EFFECTIVE
     PERM_FIELD_G PERM_FIELD_O PERM_FIELD_S PERM_FIELD_U PERM_R PERM_SETGID
     PERM_SETUID PERM_STICKY PERM_W PERM_X STAT_ACL STAT_ATIME STAT_ATIME_NS
     ...
     STAT_SYMLINK STAT_TYPE STAT_UID STAT_XATTRS S_IFMT_SHIFT
     dev_node_matches_major_minor_type file_stats_to_hash
     get_dev_node_major_minor_type get_file_type join_major_minor_dev
     mode_to_file_type split_major_minor_dev stat_path_or_fd);
