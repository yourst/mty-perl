...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(get_pids open_proc read_proc close_proc foreach_pid open_procfs
     PROC_STAT_CPU PROC_STAT_PID PROC_STAT_RIP PROC_STAT_RSS PROC_STAT_SID
     PROC_STAT_TTY pids_to_stats PROC_STAT_COMM PROC_STAT_KRSP PROC_STAT_NICE
     PROC_STAT_PGRP PROC_STAT_PPID read_proc_link read_proc_self
     PROC_STAT_FLAGS PROC_STAT_NSWAP PROC_STAT_STATE PROC_STAT_STIME
     PROC_STAT_UTIME PROC_STAT_VSIZE PROC_STAT_WCHAN get_proc_dir_fd
     read_proc_array read_proc_lines PROC_STAT_CNSWAP PROC_STAT_CSTIME
     PROC_STAT_CUTIME PROC_STAT_MAJFLT PROC_STAT_MINFLT PROC_STAT_RTPRIO
     get_pids_by_name get_proc_base_fd read_proc_matrix read_proc_subdir
     PROC_STAT_CMAJFLT PROC_STAT_CMINFLT PROC_STAT_ENDCODE PROC_STAT_EXITSIG
     PROC_STAT_SIGNALS PROC_STAT_THREADS PROC_STAT_TTYPGID read_proc_cmdline
     PROC_STAT_PRIORITY PROC_STAT_RSSLIMIT PROC_STAT_SIGCATCH
     proc_stats_to_hash PROC_STAT_NEXTALARM PROC_STAT_SCHPOLICY
     PROC_STAT_SIGIGNORE PROC_STAT_STARTCODE PROC_STAT_STARTTIME
     PROC_STAT_SIGBLOCKED PROC_STAT_STARTSTACK PROC_STAT_VMGUESTTIME
     %proc_stat_field_names PROC_STAT_VMCGUESTTIME read_proc_named_fields
     PROC_STAT_BLOCKIODELAYS read_proc_matrix_column read_proc_null_sep_array
     read_proc_nulls_to_spaces read_proc_subdir_contents
     set_process_name_in_procfs @proc_stat_field_names_list);
...
sub proc_stats_to_hash(+) {
  return pair_of_arrays_to_hash(@proc_stat_field_names_list, $_[0]);
}
