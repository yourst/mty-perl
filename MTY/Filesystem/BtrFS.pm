...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(FSOBJ_TYPE_DIR FSOBJ_TYPE_FILE FSOBJ_TYPE_OTHER FSOBJ_TYPE_SUBVOL
     is_btrfs_snapshot run_btrfs_command FSOBJ_TYPE_SYMLINK FSOBJ_TYPE_UNKNOWN
     get_btrfs_property is_subvol_writable query_btrfs_subvol
     set_btrfs_property %fs_root_to_fs_uuid %fsobj_type_to_name
     FSOBJ_TYPE_SNAPSHOT create_btrfs_subvol format_subvol_attrs
     query_btrfs_subvols remove_btrfs_subvol remove_btrfs_subvols
     update_subvol_xattrs FSOBJ_TYPE_BTRFS_ROOT create_btrfs_snapshot
     get_root_subvol_attrs FSOBJ_TYPE_MOUNT_POINT check_for_btrfs_errors
     is_btrfs_subvol_or_root parse_btrfs_subvol_attrs
     FSOBJ_TYPE_READONLY_SUBVOL FSOBJ_TYPE_WRITABLE_SNAPSHOT
     format_subvol_attrs_as_env_vars BTRFS_SPECIAL_INODE_SUBVOLUME_ROOT);
...
sub query_btrfs_subvols(;$) {
  ...
  foreach my $s (@subvol_list_to_parse) {
