...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($command_line_option_re $convert_dash_to_stdin_or_stdout
     ...
     OPTION_CHAR OPTION_COMMAS OPTION_COMMA_SEP_LISTS OPTION_DATA_TYPE_AUTO
     OPTION_DATA_TYPE_BASE OPTION_DATA_TYPE_COUNT OPTION_DATA_TYPE_MASK
     OPTION_FILE OPTION_FILE_WRITABLE OPTION_FLAGS_BASE OPTION_FLAGS_COUNT
     OPTION_FLAGS_MASK OPTION_FLOAT OPTION_HASH OPTION_HASH_EDIT
     OPTION_HASH_MANIPULATION OPTION_HELP_BANNER OPTION_HELP_BULLETED
     OPTION_HELP_CATEGORY OPTION_HELP_DEFAULT OPTION_HELP_LITERAL
     OPTION_HELP_SECTION OPTION_HELP_SPACER OPTION_HELP_SYNTAX
     OPTION_HELP_WRAPPED OPTION_INTEGER OPTION_LIST OPTION_MATCH_NAME_PREFIX
     OPTION_MATCH_NAME_SUBSTR OPTION_NO_SEP OPTION_NO_SEPARATOR_BEFORE_VALUE
     OPTION_OPT OPTION_PREFIX OPTION_REGEXP OPTION_REP OPTION_REP_TOGGLE
     OPTION_REQ OPTION_SET OPTION_SINGLE_CHAR_COMBINABLE
     ...
     OPTION_SPEC_SLOT_VARIABLE_REFERENCE OPTION_STRING OPTION_SUBSTR
     OPTION_TOGGLE OPTION_TOGGLE_BOOL OPTION_TOGGLE_BOOL_ON_EVERY_REPEAT
     ...
     expand_option_specs include_options include_option_descriptions is_meta_option
...
noexport: sub preprocess_option_spec($++) {
  ...
  my ($varref, $action_and_flags, $alias_list, $default_value_to_set, $default_value_to_reset, $symbolic_value_map, $set_extra_vars) = 
    (is_numeric($spec->[OPTION_SPEC_SLOT_ACTION_AND_FLAGS])) ? @$spec :  # (full form)
      ($spec->[OPTION_SPEC_SLOT_VARIABLE_REFERENCE], undef, $spec->[OPTION_SPEC_SLOT_ACTION_AND_FLAGS], restof($spec, 2)); # (expand abbrev form)
