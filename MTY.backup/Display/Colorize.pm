...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($B $BLINK $BLINKX $C $G $K $M $Q $R $U $UX $V $VX $W $X $Y $bgB $bgC $bgG
     $bgK $bgM $bgQ $bgR $bgW $bgY $color_enabled
     %basic_color_markup_to_code_map %color_markup_to_code_map
     %color_style_codes %custom_color_values %custom_colors
     %enhanced_color_markup_to_code_map %fixed_colors %rgb_color_values
     %rgb_colors %scaled_custom_colors %scaled_rgb_colors @all_color_symbols
     @custom_color_symbols @fixed_color_symbols ANSI_CONSOLE_ESC
     ANSI_CONSOLE_OSC ANSI_CONSOLE_SET_BG ANSI_CONSOLE_SET_FG CLEAR_LINE
     CLEAR_LINE_UP_TO_CURSOR CLEAR_REST_OF_LINE CLEAR_SCREEN CLEAR_TAB_STOPS
     COLOR_B COLOR_C COLOR_G COLOR_K COLOR_M COLOR_Q COLOR_R COLOR_W COLOR_Y
     END_OSC_ST EOE RESTORE_CURSOR_POS SAVE_CURSOR_POS SET_ANSI_COLOR_TO_RGB
     SET_TAB_IN_CURRENT_COLUMN SET_XTERM_FONT SET_XTERM_SESSION_TITLE
