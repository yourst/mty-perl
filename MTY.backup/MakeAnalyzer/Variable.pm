...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw(create_reverse_map_of_path_variable_values_to_names dump_variable
     dump_variables_in_category format_variable print_summary_of_variable
     print_summary_of_variables print_variables
     print_variables_in_all_categories print_variables_in_category);
