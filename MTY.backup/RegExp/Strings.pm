...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($backslash_newline_re $boolean_words_re $double_quoted_string_re
     $identifier_re $inside_double_quoted_re $inside_quoted_re
     $inside_single_quoted_re $leading_spaces_re $line_re
     $line_with_optional_backslash_newlines_re $lower_case_identifier_re
     $newline_or_end_re $newline_re $null_byte_re $null_terminated_string_re
     $printable_chars_re $quote_type_and_text_re $quoted_string_nocap_re
     $quoted_string_re $remove_leading_trailing_space_re
     $single_quoted_string_re $split_by_char_classes_re $tab_field_re
     $title_case_identifier_re $trailing_spaces_re
     $unicode_and_non_ascii_chars_re $upper_case_identifier_re $utf8_re
     join_backslash_newline_escaped_lines);
