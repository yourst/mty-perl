...
nobundle:; our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($any_escaped_symbol_re $redundant_escape_re $regexp_alternation_or_re
     ...
     $regexp_bracketed_char_set_nocap_re $regexp_bracketed_char_set_re
     $regexp_cap_group_start_re $regexp_case_mod_re $regexp_comment_re
     $regexp_control_re $regexp_escaped_char_class_re
     $regexp_ext_group_start_re $regexp_group_end_re $regexp_literal_char_re
     $regexp_literal_string_re $regexp_modifiers_re
