...
nobundle:; our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($auto_import_clause_re $balanced_symbol_chars_re $end_of_includes_re
     $inside_perl_quoted_string_re $noexport_re $not_prefixed_by_sigil_re
     $perl_attributes_re $perl_comment_re $perl_comments_above_sub_re
     ...
     $perl_end_block_re $perl_exports_clause_re $perl_here_doc_re
     $perl_identifier_decl_or_use_re $perl_identifier_re
     $perl_identifier_sigil_and_symbol_nocap_re
     $perl_identifier_sigil_and_symbol_re $perl_sub_argument_names_re
     $perl_keywords_re $perl_operators_re $perl_keywords_and_built_in_functions_re 
     $perl_lhs_to_rhs_mapping_expr_re $perl_package_namespaces_re
     $perl_non_global_var_decl_re $perl_optional_exports_clause_re
     $perl_package_decl_re $perl_package_decls_and_deps_re
     $perl_package_decls_re $perl_package_deps_re $perl_package_name_re
     $perl_package_namespace_separator_re $perl_package_use_re
     $perl_pod_doc_re $perl_pragma_re $perl_program_first_line_shebang_re
     $perl_q_string_re $perl_qr_quoted_regexp_re $perl_quoted_string_re
     ...
     $perl_string_re $perl_sub_decl_and_body_re $perl_sub_decl_re
     $perl_sub_proto_and_attrs_re $perl_unbalanced_delimited_block_re
     $perl_var_decl_re $perl_var_identifier_re
     $strip_non_functional_perl_syntax_re $unbalanced_symbol_chars_re
     $perl_structural_re
     %perl_keywords %perl_operators %perl_built_in_functions 
