...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($binary_digit_re $binary_literal_re $bool_literal_re $decimal_digit_re
     $decimal_literal_re $fp_literal_re $hex_digit_re $hex_literal_re
     $integer_nocap_re $integer_re $integer_sign_and_digits_with_radix_re
     $numeric_literal_nocap_re $numeric_literal_re $octal_digit_re
     $octal_literal_re $rgb_hex_triplet_re $unsigned_byte_in_decimal_re
     $unsigned_decimal_number_nocap_re $uuid_re parse_integer
     parse_rgb_hex_triplet);
