...
nobundle:; our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($show_colorized_compiled_regexps $show_pretty_compiled_regexps
     ...
     colorize_regexp_text convert_perl_regexp_to_boost_xpressive_regexp
     describe_regexp_metadata format_metadata_line
     format_regexp_parse_tree_node list_compiled_regexps
