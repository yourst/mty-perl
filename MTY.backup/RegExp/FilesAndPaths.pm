...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($absolute_path_re $basename_and_suffixes_re $directories_in_path_re
     ...
     $final_suffix_in_path_no_dot_re $final_suffix_in_path_re
     $last_path_component_re $path_component_re $path_separator_re
     $split_basename_suffixes_and_final_suffix_re
     $strip_last_path_component_re $suffixes_in_path_no_dot_re
     $suffixes_in_path_re $wildcard_re wildcards_to_regexp);
