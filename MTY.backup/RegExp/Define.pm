...
our @EXPORT = # (auto-generated by perl-mod-deps)
  qw($always_fail_re %compiled_regexp_capture_groups
     ...
     compile_regexp compile_regexp_list_of_alternatives
     ...
     regexps_declared_in_package generate_same_char_pair_re
     generate_inside_same_char_pair_re);
...
sub generate_same_char_pair_re($) {
  my ($c) = &escape_metachars_if_unescaped;
...
sub generate_balanced_char_pair_re($$) {
  my ($left, $right) = &MTY::Common::Strings::escape_metachars_if_unescaped;
...
sub generate_inside_of_balanced_char_pair_re($$) {
  my ($left, $right) = &escape_metachars_if_unescaped;
